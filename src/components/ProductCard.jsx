...
export default function ProductCard({ product, onSelect, isSelected }) {
  ...
  return (
    <div
      ...
      className={` dark:bg-[#1a1a1a] max-w-full h-full md:w-min-72 lg:w-min-72 bg-white rounded-lg hover:translate-y-1 shadow transition cursor-pointer overflow-hidden
      ${
        isSelected
